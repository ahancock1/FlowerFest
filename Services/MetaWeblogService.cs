...
//    
//   MetaWeblogService.cs can not be copied and/or distributed without the express
//   permission of Adam Hancock
// -----------------------------------------------------------------------

namespace FlowerFestival.Services
{
    using System;
    using System.Linq;
    ...
    public class MetaWeblogService : IMetaWeblogProvider
    {
        ...
        public MediaObjectInfo NewMediaObject(string blogid, string username, string password, MediaObject mediaObject)
        {
            ...
            var path = _blog.SaveFile(bytes, mediaObject.name).GetAwaiter().GetResult();
